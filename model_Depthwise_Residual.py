...
class Depthwise_Residual:
    ...
    def __init__(self,input_shape,dataset,batch_size,epoch,learning_rate):
        ...
        self.checkpoint_path='./save/Depthwise_Residual'+dataset+'Epoch'+str(self.epoch)+'.ckpt'
        if dataset=="Cifar":
            self.output_num=10
    ...
    def model_structure(self, training):
        ...
        self.Residul_1 = self.BottleNeck_1 + self.conv_2
        ...
        self.Residul_2 = self.BottleNeck_1_1 + self.conv_3
        ...
        self.Residul_3 = self.BottleNeck_3 + self.conv_4
        ...
        self.Residul_4 = self.BottleNeck_3_3 + self.conv_5
    ...
    def fit(self):
        ...
        with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
            ...
            if self.dataset == "BlindSpot":
                vali_images_strict, vali_labels_strict = self.Data_input(data_path=self.Validation_strict_data,
                                                                         Epoch=200)
            init_op = tf.group(tf.global_variables_initializer(), tf.local_variables_initializer())
            sess.run(init_op)
